...
export default function Hero() {
  return (
    <div className="mt-24 flex w-full flex-col items-center justify-center text-center">
      ...
      <h1 className="from-foreground bg-gradient-to-br from-30% bg-clip-text py-4 text-4xl leading-none font-medium tracking-tighter text-balance text-transparent sm:text-6xl md:max-w-6xl md:py-6 md:text-7xl translate-y-0 duration-600 starting:translate-y-12">
        Pick your favorite songs with your friends
      </h1>

      <p className="text-secondary-foreground mb-8 max-w-3xl text-center text-sm/5 tracking-tight text-balance sm:text-lg/6 opacity-100 duration-900 starting:opacity-0 transition-opacity">
