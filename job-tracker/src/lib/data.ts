...
export const applicationCompanyIndustry = ["Software",
	"IT Services",
	"Cloud Computing",
...
export const applicationStatus = ["applied", "accepted", "rejected"] as const;

export const applicationWork = ["remote", "hybrid", "onsite"] as const;
...
export const applications: JobApplication[] = [
	...
	},
	{
		...
		applicationDate: new Date("2023-09-30"),
		workType: "onsite",
		status: "rejected",
		isPinned: false,
	},
	...
	},
	{
		...
		companyIndustry: "Software",
		applicationDate: new Date("2023-09-25"),
		workType: "hybrid",
		status: "rejected",
		isPinned: false,
	},
	{
		...
		applicationDate: new Date("2023-09-10"),
		workType: "onsite",
		status: "accepted",
		isPinned: true,
	},
	{
		...
		applicationDate: new Date("2023-09-05"),
		workType: "remote",
		status: "rejected",
		isPinned: false,
	},
	{
		...
		applicationDate: new Date("2023-08-25"),
		workType: "hybrid",
		status: "accepted",
		isPinned: false,
	},
	{
		...
		applicationDate: new Date("2023-08-12"),
		workType: "onsite",
		status: "applied",
		isPinned: true,
	},
	{
		...
		applicationDate: new Date("2023-09-02"),
		workType: "remote",
		status: "accepted",
		isPinned: false,
	},
	{
		...
		applicationDate: new Date("2023-07-30"),
		workType: "hybrid",
		status: "rejected",
		isPinned: false,
	},
	{
		...
		applicationDate: new Date("2023-07-15"),
		workType: "onsite",
		status: "applied",
		isPinned: true,
	},
	{
		...
		companyIndustry: "Software",
		applicationDate: new Date("2023-06-20"),
		workType: "remote",
		status: "rejected",
		isPinned: false,
	},
	...
	},
	{
		...
		applicationDate: new Date("2023-07-10"),
		workType: "onsite",
		status: "applied",
		isPinned: false,
	}
